...
<section class="team-section sec-pdd-110-120">
            ...
            <div class="team-carousel four-column-carousel">
                <div class="team-member">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h3>Micale Doe</h3>
                            <div class="designation">Lawyer - Family Rights</div>
                        </div>
                ...
                <div class="team-member">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h3>James Cameron</h3>
                            <div class="designation">Lawyer - Civil Rights</div>
                        </div>
                        <div class="hover-info">
                            <h3>James Cameron</h3>
                            <div class="designation">Lawyer - Civil Rights</div>
                ...
                <div class="team-member">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h3>Dean Ambrose</h3>
                            <div class="designation">Lawyer - Estate Law</div>
                        </div>
                        <div class="hover-info">
                            <h3>Dean Ambrose</h3>
                            <div class="designation">Lawyer - Estate Law</div>
